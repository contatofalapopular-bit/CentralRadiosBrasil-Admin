const API = {
  ...
  criarModeloRadioEssencial() { return this.worker("/api/admin/comercial/modelos-site/radio-essencial", { method: "POST", body: "{}" }); },
  ...
  detalharConteudoSiteComercial(id) { return this.worker(`/api/admin/comercial/sites/${encodeURIComponent(id)}/conteudo`); },
  salvarConteudoSiteComercial(id, dados) { return this.worker(`/api/admin/comercial/sites/${encodeURIComponent(id)}/conteudo`, { method: "PATCH", body: JSON.stringify(dados) }); },
  publicarSiteComercial(id) { return this.worker(`/api/admin/comercial/sites/${encodeURIComponent(id)}/publicar`, { method: "POST", body: "{}" }); },
